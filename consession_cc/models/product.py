...
class ProductTemplate(models.Model):
    ...
    cout_accessoire_session = fields.Float(string="Accessoires")
    ...
    def compute_cout_reprise_total(self):
        self.cout_reprise_total = self.standard_price + self.cout_cession_interne + self.cout_travaux_extérieur + self.cout_accessoire_session + self.cout_autre_session
